...
* 先設![equation](http://www.sciweavers.org/tex2img.php?eq=g%2Bsin%28mc%5E2%29&bc=White&fc=Black&im=jpg&fs=12&ff=arev&edit=) 為已知反覆利用以下公式計算 $E_i$ 和 $g$ 的值，直到converge (此處直接設定做8個循環)
